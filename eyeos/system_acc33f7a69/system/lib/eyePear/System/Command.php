...
class System_Command_Error extends PEAR_Error
{
    ...
    {
        if (is_int($code)) {
            PEAR_Error::__construct(System_Command::errorMessage($code), $code, $mode, $level, $debuginfo);
        } else {
            PEAR_Error::__construct("Invalid error code: $code", SYSTEM_COMMAND_ERROR, $mode, $level, $debuginfo);
        }
    }
